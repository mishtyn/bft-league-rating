...
object Main extends App {
  ...
  val competitionConfigs = List(
    ...
    CompetitionConfig(
      name = CompetitionName("Акватлон. Солигорск"),
      events = List(
        EventConfig(
          EventName("Акватлон. Солигорск", "SoligorskAquathlon"),
          EventCategory.Multi,
          ResourcePath("2026/SoligorskAquathlon"),
          EventResultsReader.Configured(
            "Участник",
    ...
    CompetitionConfig(
      name = CompetitionName("Кросс-триатлон. Браслав"),
      events = List(
        EventConfig(
          EventName("Кросс-триатлон. Браслав", "KrossTriathlonBraslav"),
          EventCategory.Multi,
          ResourcePath("2026/KrossTriathlonBraslav"),
          EventResultsReader.Configured(
            "Фамилия Имя",
            ParseResult.HoursMinutesSecondsMillisOrTens("Время"),
            ParseGender.ByField("Пол", "М", "Ж")
